...
CGには`takt/workflows/aidlc-code-generation.yaml`、工程の作成・レビューには`takt/workflows/aidlc-construction-stage.yaml`を使う。ローカルの指示・ポリシー・知識・出力契約も固定入力になる。ペルソナはTAKT 0.65.0の組み込みを使う。
