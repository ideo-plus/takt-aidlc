...
[English](code-generation-stage.md)

<a id="integration-structure"></a>
...
<a id="mapping-native-cg-responsibilities"></a>
...
<a id="original-sources-passed-to-takt"></a>
...
<a id="sensors-and-success-conditions"></a>
...
<a id="outputs-and-state"></a>

## 出力と状態

`aidlc/takt-handoff/code-generation-stage-runs/<id>/`に保存する。
...
導入は[設定手順](getting-started.ja.md)、確認済みの範囲は[CG検証記録](../experiments/code-generation/RESULTS.ja.md)を参照。
